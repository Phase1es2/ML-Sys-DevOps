...
from dataloader import get_dataloaders_from_path  # ✅ 修改为基于路径读取数据
...
def main(args):
    ...
    with mlflow.start_run(log_system_metrics=True):
        ...
        # ✅ 使用 scripts/make_pairs.py 生成的数据路径
        data_path = "/mnt/block/MyRetrainSet/train"
        train_loader, val_loader = get_dataloaders_from_path(data_path, batch_size=args.batch_size, val_split=0.1)
